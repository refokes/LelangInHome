...
public class HasilLelangActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onStart() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new LelangAdapter(HasilLelangActivity.this, dataList);
    ...
    private void eventListener() {
        recyclerViewBarang.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                    ...
                    Intent intent = new Intent(HasilLelangActivity.this, DetailHasilLelangActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_barang) {
            ...
            if (lvl.equals("Admin")){
                ...
                Toast.makeText(HasilLelangActivity.this, "Maaf ini Fitur khusus admin dan petugas", Toast.LENGTH_LONG).show();
            }
            ...
            mAuth.signOut();
            finish();
            startActivity(new Intent(HasilLelangActivity.this, LoginActivity.class));
        }
